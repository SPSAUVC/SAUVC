...
#                 print("Gate @ right")
    ...
    if (0< error[0] <5):
        #This time around I'm not using any preset timer to stop the thrusters.
        #Instead I'm using the sonar to stop the vehicle exactly 2.5(1 lane) infront of the gate.
        #
        #2.5m + ~12m = ~14.5m
        #We would need to stop the vehicle when the sonar detects 14.5m (1450cm)
        ...
        if distance < 1450:
            ...
            stop()
            import CompetitionCode_Path1_part4.py
